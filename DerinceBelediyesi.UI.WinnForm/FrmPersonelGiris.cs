    ...
    public partial class FrmPersonelGiris : Form
    {
        ...
        private void btnGiris_Click(object sender, EventArgs e)
        {
            ...
            {//eger burada hata alırsan cathdeki blogta yazılan mesaj bana hata vermesini göstercek
                string kullaniciadisoyadi = bll.PersonelGirisi(bilgiIslemKullaniciGiris);
                if (kullaniciadisoyadi == "")
                {
                    MessageBox.Show("TC Kimlik numaranız veya şifreniz yanlış. Ya da yetkiniz personel veya müdür değildir.","Hata",MessageBoxButtons.OK,MessageBoxIcon.Error);
                }
                ...
                else
                {
                    ...
                    Form formekranı = new FrmStokIslemleri();
                    formekranı.Text = "Personel : " + kullaniciadisoyadi;
                    formekranı.Show();//formstok işlemleri açılsın
